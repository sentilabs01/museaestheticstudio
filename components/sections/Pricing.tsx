...
const signaturePackages = [
  {
    ...
    price: '$225',
    description: "A luxurious facial experience designed to melt away tension and restore your skin's natural balance."
  },
  {
    name: 'Cell Story Liquid Microneedling',
    price: '1 session: $200 | 4 sessions: $800',
    description: 'Stimulate collagen production and improve texture with this advanced microneedling treatment.'
  },
  {
    name: 'Skin-Vigorate Package',
    price: '$1,250',
    description: 'Includes: 2 Oxy-Facial w/ LED, 2 Certified Dope Facials, 2 BioRePeel, 2 Cell Story Microneedling.'
  },
]

const standAloneTreatments = [
  { name: 'Express Facial', price: '$110', description: 'Quick yet effective refresh for your skin.' },
  { name: 'Oxy-Facial with LED', price: '$135', description: 'Deep hydration and rejuvenation with LED.' },
  { name: 'Dermaplane Facial', price: '$135', description: 'Ultra-smooth complexion and enhanced product absorption.' },
  { name: 'Hydro-Facial with LED', price: '$145', description: 'Cleanse, exfoliate, and hydrate for a radiant look.' },
  { name: 'Chemical Peel', price: '$99–$125', description: 'Customized exfoliation for improved texture and tone.' },
  { name: 'Body Peel', price: '$99–$250', description: 'Targeted peel for body areas to smooth and brighten.' },
  { name: 'BioRePeel', price: '$150–$500', description: 'Powerful yet gentle peel for rejuvenation.' },
  { name: 'Lash Lift & Tint', price: '$125', description: 'Beautiful curl and definition for your lashes.' },
  { name: 'Brow Lamination', price: '$80', description: 'Perfectly shaped, full brows.' },
  { name: 'Lash Lift & Tint with Brow Lamination', price: '$195', description: 'Dramatic effect for lashes and brows.' },
  { name: 'Nano-Infusion Treatment', price: '$150–$500', description: 'Potent serums for hydration and texture.' },
]
      ...
      <div className="max-w-8xl mx-auto">
        ...
        {!showMembership ? (
            <PricingSection
              ...
              subtitle="Choose the best treatment for your needs"
              frequencies={['once']}
